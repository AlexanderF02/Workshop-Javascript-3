...
// Task 1: Create an array called values
const values = [0, "hello", null, undefined, false, "false", -1, "JavaScript"];

// Task 2: Function to check truthiness
...
// Task 3: Loop through values array using forEach
values.forEach(checkTruthiness);

// Task 4: Loop through values array using a for-loop
for (let i = 0; i < values.length; i++) {
  checkTruthiness(values[i]);
}

// Task 5: Loop through values array using a while-loop
let index = 0;
